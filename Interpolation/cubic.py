...
def interpolate_files(uniform_folder_path, nonuniform_folder_path, output_folder_path):
    r2_scores = []
    mean_square_errors = []
...
if __name__ == "__main__":
    # uniform = input("Enter uniform Folder")
    # non_uniform = input("Enter non_uniform Folder")
    # output_folder = input("Enter output Folder")
# interpolate_files(r"D:\CubicSplineInterpolationnn\uniform_all", r"D:\CubicSplineInterpolationnn\non_uniform_all",r"D:\CubicSplineInterpolationnn\interpolated_files")

    interpolate_files("D:\\Interpolationnnn\\uniform_all\\",
                 "D:\\Interpolationnnn\\non_uniform_all\\",
                 "D:\\Interpolationnnn\\interpolated_files_cubic\\")
