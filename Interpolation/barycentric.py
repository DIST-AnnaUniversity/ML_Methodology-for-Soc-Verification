...
def interpolate_files_barycentric(uniform_folder_path, nonuniform_folder_path, output_folder_path):
    ...
    for file in t1:
        ...
        for i in df.columns:
            conv = df[i].to_numpy()
            interp_func = BarycentricInterpolator(non_time, conv)
...
if __name__ == "__main__":
    interpolate_files_barycentric("D:\\Interpolationnnn\\uniform_all\\",
                 "D:\\Interpolationnnn\\non_uniform_all\\",
                 "D:\\Interpolationnnn\\interpolated_files_bary\\")
