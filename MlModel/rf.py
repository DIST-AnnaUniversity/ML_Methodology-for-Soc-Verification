...
# # Set the number of estimators to 10
# n_estimators = 10

# # Create the random forest regressor with the specified number of estimators
# rf_regressor = RandomForestRegressor(n_estimators=n_estimators)

# # Fit the regressor to your data and perform further analysis
# # rf_regressor.fit(X_train, y_train)
# # y_pred = rf_regressor.predict(X_test)
# # Perform evaluation, etc.
...
def get_user_input2():
    ...
    est = simpledialog.askinteger("Input", "enter the no of trees for random forest modelling:")
    deep = simpledialog.askinteger("Input", "enter the depth of trees for random forest modelling:")
   
    #  est=int(input("enter the no of trees for random forest modelling:"))
    # deep=int(input("enter the depth of trees for random forest modelling:"))

    return est, deep
# Example usage
# n, name = get_user_input()
# print("Number of persons:", n)
# print("Name of the head:", name)
